...
class CppLspAdapter(LspLanguageAdapter):
    ...
    def parse_import(
        ...
        Handles system includes (``#include <iostream>``) and local includes
        (``#include "mylib.hpp"``).
    ...
    def resolve_module_path(
        ...
        Args:
            module_name: Header file name (e.g. ``"mylib.hpp"``).
