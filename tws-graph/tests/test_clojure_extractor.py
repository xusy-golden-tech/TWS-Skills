...
class TestClojureExtractor:
    ...
    def test_ns_declaration(self):
        ...
        nodes, edges = _parse("(ns myapp.core)")
    ...
    def test_defn_declaration(self):
        ...
        nodes, edges = _parse("(defn greet [name] (str \"Hi\" name))")
    ...
    def test_defmacro_declaration(self):
        ...
        nodes, edges = _parse("(defmacro when-pos [n body] `(when (pos? ~n) ~body))")
    ...
    def test_ns_require_imports(self):
        ...
        nodes, edges = _parse("(ns myapp (:require [clojure.string :as str]))")
    ...
    def test_ns_import_java(self):
        ...
        nodes, edges = _parse("(ns myapp (:import [java.util Date]))")
        import_edges = [e for e in edges if e["kind"] == "imports"]
        assert len(import_edges) >= 1
    ...
    def test_function_call(self):
        ...
        nodes, edges = _parse("(println \"Hello\")")
    ...
    def test_nested_function_call(self):
        ...
        nodes, edges = _parse("(str (upper-case \"hello\"))")
    ...
    def test_full_fixture_file(self):
        ...
        nodes, edges = clojure_extract(source, tree, "Sample.clj")
